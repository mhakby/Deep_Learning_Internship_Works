...
# Train the model
# Define class weights for four classes
class_weights = {0: 1, 1: 2, 2: 3, 3: 4}

# Train the model with the updated class weights
history = model.fit(X_train, y_train_categorical, class_weight=class_weights, epochs=30,
